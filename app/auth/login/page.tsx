    ...
    <main className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm">Prediction Market Scanner</p>
        </div>
        ...
        <p className="text-center text-xs text-gray-700 mt-1">
          <Link href="/auth/forgot" className="hover:text-gray-500">Forgot password?</Link>
        </p>
        <p className="text-center text-xs text-gray-700 mt-3">
          <Link href="/dashboard" className="hover:text-gray-500">← Back to dashboard</Link>
        </p>
      </div>
    </main>
  );
