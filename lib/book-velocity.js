...
const DEFAULTS = {
   ...
   *  Expected fire rate over the REAL tracked set (120 Polymarket + 200 Kalshi
   *  reward markets), from the 17-day executable-move ceiling measured on that
   *  population (scripts/book-velocity-baserate.js): Polymarket needs >=3c →
   *  10.4/day ceiling, Kalshi needs >=8c → 5.1/day ceiling, combined 15.5/day.
   *  Times the 66% persistent share leaves ~10/day, before the 60s-horizon
