...
// app): Mentions, Esports, Sports, Elections, Crypto, Weather, Health, Tech,
// Economy, Financials, Business, Pop Culture, Geopolitics, World, Politics
// (+ 'other' residual).
//
// ORDER MATTERS — categories are checked most-specific-first so overlaps resolve
// deterministically:
//   • Esports before Sports (every esports event also carries the "Sports" tag).
...
//   • Geopolitics before World (every geopolitics event also carries the "World"
//     tag; conflict-zone markets → Geopolitics, broader international → World).
//   • World before generic Politics.
...
const CATS = [
  ...
  // ── Esports (its own real Polymarket category — checked BEFORE Sports because
  //    every esports event on Polymarket ALSO carries the generic "Sports" tag, so
  //    the specific 'Esports'/game-title tag must win). ────────────────────────
  { label: 'Esports',
    tags: ['esports', 'e-sports', 'lol', 'league of legends', 'cs2', 'csgo',
      'counter-strike', 'counter strike 2', 'dota', 'dota 2', 'valorant', 'overwatch',
      'rocket league', 'starcraft', 'call of duty', 'rainbow six', 'pubg', 'apex legends',
      'fortnite'],
    phrases: ['esports', 'e-sports', 'counter-strike', 'counter strike', 'cs2', 'csgo',
      'dota', 'valorant', 'league of legends', 'rocket league', 'overwatch', 'starcraft',
      'call of duty', 'rainbow six', 'apex legends', 'lck', 'lpl', 'lec'] },

  // ── Sports (checked after Esports; early for weather-named teams + slug codes) ─
  { label: 'Sports',
    ...
    phrases: ['sports', 'nba', 'nfl', 'nhl', 'mlb', 'wnba', 'ncaa', 'soccer', 'tennis',
      ...
      'player of the year', 'end in a draw', 'exact score', 'moneyline', 'grand prix',
  ...
  // ── Geopolitics (its own real Polymarket category — checked BEFORE World because
  //    every geopolitics event on Polymarket ALSO carries the generic "World" tag,
  //    so the specific 'Geopolitics' tag / conflict-zone terms must win). ────────
  { label: 'Geopolitics',
    tags: ['geopolitics', 'middle east', 'foreign policy', 'military actions', 'war',
      'conflict', 'iran', 'israel', 'russia', 'ukraine', 'syria', 'north korea', 'nato',
      'united nations', 'taiwan'],
    phrases: ['geopolitics', 'geopolitical', 'strait of hormuz', 'hormuz', 'iran', 'iranian',
      'israel', 'gaza', 'palestine', 'ukraine', 'russia', 'putin', 'zelenskyy', 'khamenei',
      'netanyahu', 'north korea', 'kim jong', 'taiwan', 'syria', 'ceasefire', 'hostage',
      'regime', 'military invasion', 'military clash', 'united nations', 'nato',
      'foreign policy', 'annex', 'invade', 'peace deal', 'sovereignty'] },

  // ── World (broader international; checked after Geopolitics, before Politics) ──
  { label: 'World',
    tags: ['world', 'china', 'venezuela', 'cuba', 'greenland'],
    phrases: ['china', 'chinese', 'venezuela', 'cuba', 'greenland', 'brexit', 'world chess',
