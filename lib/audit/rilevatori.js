...
//       che `MARKET_CAP_PCT` e `MARKET_CAP_FIXED_USD` sono lo stesso tetto. La tabella è curata a
//       mano e va allungata quando se ne scopre un altro: è documentazione eseguibile, non magia.
const CONCETTI = [
  {
    nome: 'tetto per mercato',
    // I due nomi storici restano in elenco DI PROPOSITO: se qualcuno li reintroduce, questo rilevatore
    // deve accorgersene. Dal 9 agosto 2026 il tetto e' `MARKET_CAP_FIXED_USD`, un valore FISSO in
    // dollari, e vive in un modulo solo — chi lo consuma lo importa, non lo ridichiara.
    nomi: ['MARKET_CAP_FIXED_USD', 'MARKET_CAP_PCT', 'CONCENTRATION_CAP_FRAC'],
    nota: 'il tetto di capitale per singolo mercato (YES+NO sommati). Il 7 agosto 2026 valeva 0,20 nel motore e 0,30 nel pianificatore: il vincolo piu stretto vinceva comunque, ma il piano proponeva righe che il quoting poi tagliava. Dal 9 agosto 2026 e un valore fisso in dollari, scritto in lib/rewards/concentration.js e importato da tutti e quattro i consumatori.',
  },
  {
