...
// `esenzioneEsposizione` e' la PROVA di chiusura gia' fatta dal chiamante (esenzione-chiusura.provaChiusura),
// non una dichiarazione: qui viene solo inoltrata al limite 2. Vedi il blocco sul LIMITE 2 in risk-limits.
function evaluateForOrder({ userId, venue, order, esenzioneEsposizione = null }) {
  ...
  const limits = riskLimits.evaluateLimits({ order, usage, limits: resolved.limits, esenzioneEsposizione });
...
module.exports = {
  ...
  risolviDuplicato: executionAudit.risolviDuplicato,
