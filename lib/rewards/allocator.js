...
const APY_CAP = 200;
// ── QUANTI MERCATI PUÒ TENERE UN PIANO ──────────────────────────────────────────────────────────────
// Era 25. Su 21 maker misurati (data/manuale-operativo-maker-v2.md) i mercati tenuti insieme hanno
// mediana 10 (Q1 6 · Q3 22) — ma il dato che decide non è la mediana: è il SEGNO della correlazione.
// La resa per dollaro correla NEGATIVAMENTE con tutti e tre gli indici di scala (capitale ρ −0,58,
// nuovi mercati al giorno ρ −0,51, mercati contemporanei ρ −0,46). Allargarsi peggiora l'efficienza,
// e chi sta in fondo alla classifica lo fa su 28 mercati al giorno.
//
// 10 è la mediana del campione, ed è anche il tetto che il capitale impone: con $620 e 10 mercati
// restano ~$62 a mercato, cioè ~$31 per lato — dentro la forchetta del nozionale osservato ($16–74,
// mediana $34). A 25 mercati sarebbero $12 a lato, sotto `rewardsMinSize` sulla maggior parte del board.
const MAX_MERCATI_PIANO = 10;
...
function planFromCollection(opts = {}) {
  ...
  const { montepremiSufficiente, MIN_POT_USD_PER_DAY } = require('./montepremi-minimo');
  ...
  return {
    ...
    montepremiPavimentoUsd: soloQuesti ? null : MIN_POT_USD_PER_DAY,
    montepremiSottoPavimento: soloQuesti ? null : sottoMontepremi.length,
