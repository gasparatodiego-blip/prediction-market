...
function planFromCollection(opts = {}) {
  ...
  const plan = capital > 0
    ? planAllocation({ byMarket: fundable, marketTokens, tapeByToken: tape.byToken, potByCond, budgetUsd: capital, offsetCents: 1, maxInventoryUsd: 5000, policy: 'hold', maxCount: 25, maxSpreadByMarket, fillScoreByMarket, endDateByMarket, minSizeByMarket, horizonFilter, maxPerMarketUsd: opts.maxPerMarketUsd ?? null, usePairCost: opts.usePairCost !== false, nowMs })
