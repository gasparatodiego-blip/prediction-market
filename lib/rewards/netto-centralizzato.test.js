...
console.log('\n══ 5 · IL TETTO PER MERCATO È IN UN PUNTO SOLO, E LO IMPORTANO IN QUATTRO');
{
  ...
  ok('  $2.000 di capitale alzano il tetto solo perché servirebbero più di MAX_MERCATI mercati',
    capPerMarketUsd(2000) > MARKET_CAP_FIXED_USD && capPerMarketUsd(1000) === MARKET_CAP_FIXED_USD,
    `$1000→${capPerMarketUsd(1000)} · $2000→${capPerMarketUsd(2000)}`);
