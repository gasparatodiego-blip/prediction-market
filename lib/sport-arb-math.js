...
const POLY_FEE_NOTE =
  'polymarket takerBaseFee=1000 in gamma with undocumented units; 1% assumed pending confirmation';
...
module.exports = {
  EXCHANGES, EXCHANGE_COMMISSION, kalshiFee, POLY_TAKER, POLY_FEE_NOTE,
