...
// Normalise a raw data-api /positions row to the stored/feed shape. Shared by the
// agent30 feed writer AND the on-demand refresh in the feed route so both paths
// produce byte-identical position objects (no feed-vs-ondemand drift).
...
module.exports = { fetchOpenPositions, normPosition, OPEN_PAGE, OPEN_SCAN_MAX_PAGES };
