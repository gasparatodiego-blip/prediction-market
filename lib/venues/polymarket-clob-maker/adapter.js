...
function createMakerAdapter(opts = {}) {
  ...
  return { kind: 'maker', mode, dryRun, canWrite, liveMinCapUsd, orderTtlSeconds, postOrder, cancelOrder, cancelMarketOrders, listOpenOrders, getPositions, healthCheck, close };
}
