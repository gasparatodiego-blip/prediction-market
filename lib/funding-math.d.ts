...
export declare const VENUE_FEE_PCT: { cex: number; gateio: number; bitget: number; dex: number; dydx: number; aster: number; paradex: number; edgex: number; grvt: number; lighter: number; extended: number; pacifica: number };
