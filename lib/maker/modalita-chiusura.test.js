...
(async () => {
  console.log('\n════ 1 · FILL PARZIALE 40/100 ════');
  {
    ...
    ok('le 60 share NON FILLATE restano a libro: maturano premi finche la coppia non e completa',
  ...
  console.log('\n════ 1-bis · COPPIA COMPLETA: IL RESIDUO VIENE CANCELLATO ════');
  {
    ...
    // ⚠ E NON SI CANCELLA FINCHE' LA COPPIA NON E' COMPLETA: la stessa fixture con una copertura
    // parziale (40 possedute, 25 coperte) deve lasciare il residuo dov'e'.
    ...
    ok('con la coppia coperta solo in parte il residuo NON si tocca',
