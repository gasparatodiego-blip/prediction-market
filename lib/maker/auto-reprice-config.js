...
function readAutoRepriceConfig(deps = {}) {
  ...
  return {
    ...
    // LA ALLOWLIST DEL GATE live-min: qui si', l'unione. La legge `manual-order` per costruire
    // l'adapter, ed e' l'unico consumatore che deve poter gestire una posizione gia' esposta.
