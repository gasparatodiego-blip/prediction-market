...
//     • auto-reprice ON: a 15-minute GTD expiry that agent40-manual-reprice RENEWS PROACTIVELY with 3
//       minutes still on it, and re-prices early whenever the mid pushes the order out of the reward band
//       (lib/maker/auto-reprice.js). So time never kills a healthy order — but the expiry is real, and it
//       is the DEAD-MAN'S SWITCH: if this host stops, nothing renews and the EXCHANGE retires the order
//       within 15 minutes, with no second supervisor anywhere in the picture.
 ...
 *   auto-reprice ON             → GTD, RESTING_GTD_SECONDS (15 minutes). NOT a clock the order has to
 ...
 *                                 stops, nothing renews and the venue retires the order within 15 minutes
 *                                 with no second supervisor needed anywhere.
 *
