...
console.log('\n── il ramo del riposizionamento dichiara la chiusura, e nessun ramo di APERTURA lo fa');
{
  ...
  // E il conteggio dei percorsi che lo dichiarano è quello atteso: sette, tutti di chiusura.
  const quanti = (nudo.match(/chiudePosizione: true/g) || []).length;
  ok('i percorsi che dichiarano la chiusura sono sette', quanti === 7, String(quanti));
