...
// ── UNA SOLA MISURA DI ORIZZONTE, LETTA DA UN SOLO PUNTO (12 agosto 2026) ────────────────────────
// Qui c'era `24` scritto a mano, mentre il pianificatore usava `MIN_HORIZON_DAYS = 0.75` (18 ore): fra
// 18 e 24 ore esisteva una fascia in cui il piano allocava e la verifica rifiutava, per costruzione e
// per sempre. E' cio' che ha fermato il ciclo del 12 agosto dopo tre ricalcoli (§5 punto 98).
// Adesso la soglia e' DERIVATA dalla stessa costante del pianificatore: cambiarne una le cambia
// entrambe, e non possono piu' divergere.
const { MIN_HORIZON_DAYS } = require('../rewards/horizon');
const HORIZON_MIN_HOURS = MIN_HORIZON_DAYS * 24;   // derivato: 0,50 g = 12 h
