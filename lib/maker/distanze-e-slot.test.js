...
function lungoBasso(n) { return { ...lungo(n), rewardsMinSize: 20 }; }
function lungo(n) {
...
// 20 lunghi ammissibili. ⚠ LA COMPOSIZIONE DEL FIXTURE E' PARTE DELL'ESPERIMENTO: la quota «basso»
// a 12 slot vale 4 (dal 23/08), quindi con un board tutto «alto» a fermare i dieci sarebbe il
// SECCHIO (8 posti) e non la fascia — e questo blocco sta provando la FASCIA. Servono >= 4 «basso».
const boardL = Array.from({ length: 20 }, (_, i) => (i < 6 ? lungoBasso(i + 1) : lungo(i + 1)));
