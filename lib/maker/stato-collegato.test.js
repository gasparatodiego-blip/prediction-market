...
console.log('\n══ IL CASO CHE HA FATTO NASCERE IL CONTROLLO, RIMESSO IN PIEDI');
{
  ...
  // L'asserzione guarda l'INTENTO, non la lista esatta degli argomenti: quando alla conferma è stato
  // aggiunto il montepremi da confrontare col venue (`potAtPlan`), una regex ancorata a
  // `addMarket(addPreview.marketId, false)` è diventata rossa su una modifica corretta. Un test che si
  // rompe quando si aggiunge un parametro protegge la firma, non il comportamento.
