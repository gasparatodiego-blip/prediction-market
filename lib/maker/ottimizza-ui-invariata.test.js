...
const CONTROLLI_ATTESI = Object.freeze([
  ...
  'data-alloc-queue-add',            // mette un mercato proposto nella coda di conferme (non piazza)
  'data-alloc-queue-confirm',        // apre il pannello ordine sul mercato in testa alla coda
  'data-alloc-queue-skip',           // toglie dalla coda senza piazzare
  'data-alloc-queue-cancel',         // svuota la coda (i già piazzati restano)
  'data-alloc-add-confirm-btn',      // conferma dell aggiunta di un mercato proposto (passo 2 di 2)
  'data-alloc-auto-preview',         // anteprima di un mercato proposto (passo 1 di 2)
