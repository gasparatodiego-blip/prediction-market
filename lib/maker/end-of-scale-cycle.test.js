...
const AR_DEPS = {
  ...
  // §4.8: lo scope e' «mercati abilitati UNIONE mercati dove c'e' gia' capitale esposto», e la seconda
  // meta' viene dallo snapshot VIVO delle posizioni. Con una posizione aperta sul bot vero — il 18
  // agosto 2026: 6 share di Hong Kong — il ciclo visitava DUE mercati invece di uno, e siccome
  // `resolveRules` e `listOrders` di questo banco rispondono uguale per qualunque id, lo STESSO ordine
  // veniva rinnovato due volte. L'asserzione «un solo rinnovo» diventava rossa a bot fermo e verde a
  // bot senza posizioni: misurava lo stato del venue, non il codice.
