 ...
 */
function sizeScale({ minSize, price, capitalUsd } = {}) {
  ...
  if (lo == null || px == null || cap == null) return { readable: false, lo, hi: null };
  return { readable: true, lo, hi: Math.max(lo, Math.floor(cap / px)) };
}
