...
{
  const d = tmp();
  // PUNTO 7 · IL DEFAULT E CAMBIATO: il generale nasce ACCESO. Per provare l AND bisogna quindi
  // spegnerlo esplicitamente, cosa che prima era lo stato di partenza.
  ...
  ok('mercato acceso ma generale SPENTO a mano ⇒ NON agisce', v.enabled === false);
