...
const regole = (mid, bid, ask) => ({
  ...
  // ⚠ AGGIUNTO IL 18 AGOSTO 2026 con il cancello di freschezza in `auto-close`: da allora il file
  // rifiuta di vendere contro un bid che non si puo' datare. Questa fixture descriveva un book LIVE e
  // FRESCO senza dirlo — cosa che prima non serviva. Dichiararlo non indebolisce niente: rende esplicito
  // il presupposto su cui il test gia' si reggeva, ed e' esattamente cio' che la produzione fornisce
  // quando la sottoscrizione e' viva (`resolveMarketRules` popola `midSource`/`midAgeSec`).
  midSource: 'live-book', midAgeSec: 3,
  feedVitality: { assetsWithEvents: 200, seededAssets: 282, totalAssets: 282, windowMs: 30000 },
