...
//
// agent35-maker (CJS, pm2) cannot require the TypeScript credentials.ts, so this module is the require()-able
// equivalent of its makerProviders: it turns stored Prisma custody into the two thunks createMakerAdapter
