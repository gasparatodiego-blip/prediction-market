...
/**
 * DOVE PIAZZARE L'USCITA. Obiettivo carico +1%, tenuto DENTRO la banda premiante.
 *
 ...
 *
 * NON esiste piu' nessun pavimento: l'uscita non viene mai spinta SOTTO l'obiettivo. Se la banda e'
 * scesa tanto da non contenere piu' un prezzo profittevole, non si piazza un'uscita in perdita — se ne
 * occupa `decideExit`, che chiude a mercato.
 */
function planExit({ entryPrice, scoringMid, tick, bandRadiusCents = null, profitPct = EXIT_PROFIT_PCT } = {}) {
  ...
  return { ok: true, price, reason, target, bandLo: b.lo, bandHi: b.hi, clampedBy, profitPct: realizedPct };
}
