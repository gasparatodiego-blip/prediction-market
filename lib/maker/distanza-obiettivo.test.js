...
console.log('\n════ ③-bis IL MARGINE DAL BORDO — adattivo alla BANDA, non alla griglia ════');
{
  ...
  // E non scende mai sotto il pavimento in tick, nemmeno su una banda strettissima.
  ok('  e non scende mai sotto un tick', D.margineEffettivoTick({ tick: 0.01, maxSpreadCents: 0.5 }) >= 1);
