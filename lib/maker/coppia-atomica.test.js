...
(async () => {
  ...
  {
    // Massachusetts, i numeri veri del 12 agosto: mid 0,04, capitale $26 ⇒ la gamba NO costa ~$25,5 e
    // sfonda il tetto di $21,34, l'altra costa ~$1,06 e passerebbe.
    const m = mondo({ orderCap: TETTO });
    const righe = coppiaAlMid(MKT, 0.04, 26);
  ...
  console.log('\n══ 2 · LO STESSO MERCATO CON LE GAMBE INVERTITE: STESSO ESITO');
  {
    ...
    const dritte = coppiaAlMid(MKT, 0.04, 26);
