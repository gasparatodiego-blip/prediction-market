...
console.log('\n── 3 · LE DUE CINTURE ESENTANO GLI STESSI ORDINI, E SOLO IL CAP live-min');
{
  ...
  // ⚠ OTTO DAL 17 AGOSTO 2026: si è aggiunta l'USCITA ORDINARIA quando la scala d'urgenza concede di
  // attraversare lo spread (permesso dell'operatore, `attraversamento-uscita.js`). Riduce come tutte
  // le altre — è un SELL di share già possedute — e la dichiarazione le serve per la stessa ragione
  // delle sette precedenti: senza, `provaChiusura` non viene nemmeno interrogata e il tetto per ordine
  // rifiuterebbe la vendita di una posizione che stiamo cercando di chiudere.
  ok(`auto-close dichiara la chiusura in ${dichiarazioni} punti (L1+sorella · incremento sorella · chiusura rapida · riposizionamento · i 2 rami pre-scadenza · uscita forzata · uscita che attraversa)`,
    dichiarazioni === 8, String(dichiarazioni));
