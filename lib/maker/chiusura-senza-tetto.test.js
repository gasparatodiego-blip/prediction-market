...
console.log('\n── 9 · UN MERCATO MORTO NON RESTA IN SEI REGISTRI');
{
  ...
  ok('i registri governati sono sei', PUL.REGISTRI.length === 6);
  ok('  e sono quelli che il quadro elencava',
    PUL.REGISTRI.map((r) => r[0]).join(',') === 'attesaMerge,residui,chiusura,tetto,manuale,autoClose');
