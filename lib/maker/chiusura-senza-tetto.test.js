...
console.log('\n── 3 · LE DUE CINTURE ESENTANO GLI STESSI ORDINI, E SOLO IL CAP live-min');
{
  ...
  ok(`auto-close dichiara la chiusura in ${dichiarazioni} punti (L1+sorella · chiusura rapida · i 2 rami pre-scadenza · uscita forzata)`,
    dichiarazioni === 5, String(dichiarazioni));
  for (const [nome, f] of [
