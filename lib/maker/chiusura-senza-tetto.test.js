...
console.log('\n── 3 · LE DUE CINTURE ESENTANO GLI STESSI ORDINI, E SOLO IL CAP live-min');
{
  ...
  ok(`auto-close dichiara la chiusura in ${dichiarazioni} punti (L1+sorella · incremento sorella · chiusura rapida · riposizionamento · i 2 rami pre-scadenza · uscita forzata)`,
    dichiarazioni === 7, String(dichiarazioni));
