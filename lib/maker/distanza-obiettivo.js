 ...
 * `max(margine in tick, frazione di v)`, arrotondato in su a un intero di tick.
...
function margineEffettivoTick({ tick = null, maxSpreadCents = null, margineTick = undefined, frazione = undefined, env = process.env } = {}) {
  ...
  return Math.max(base, daFrazione);
}
...
module.exports = {
  ...
  ENV_MARGINE_FRAZIONE, MARGINE_BORDO_FRAZIONE_DEFAULT,
