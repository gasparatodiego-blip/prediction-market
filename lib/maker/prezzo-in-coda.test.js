...
console.log('\n══ I TRE PERCORSI LO DICHIARANO, LA CHIUSURA FORZATA NO');
{
  ...
  // Dall'8 agosto 2026 auto-close ha DUE coppie di questi marcatori, non una: l'uscita (maker in coda /
  // chiusura forzata che attraversa) e il merge (Livello 2 in coda / Livello 1 che attraversa). Restano
  // righe DISTINTE, ed e' quello che questo banco difende: nessun punto del codice deve poter essere
  // insieme «aspetto il mio turno» e «attraverso adesso».
  ok('  e le due sono righe distinte', (ac.match(/inCoda: true/g) || []).length === 2 && (ac.match(/attraversaApposta: true/g) || []).length === 2,
