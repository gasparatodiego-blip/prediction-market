...
const KEYWORDS = [
  // Sports (all categories for cross-matching with OddsAPI)
  ...
  'win', 'beat', 'defeat', 'qualify', 'advance', 'title', 'winner',
  'atp', 'wta', 'roland garros', 'french open', 'australian open',
  'world series', 'stanley cup', 'nfl draft', 'transfer', 'signing',
  // Technology & AI
  ...
  'acquisition', 'merger', 'ipo', 'ceo', 'layoff', 'startup',
  'deepmind', 'mistral', 'claude', 'grok', 'llama', 'regulation ai',
  ...
  'treasury', 'yield', 'bond', 'mortgage rate', 'pce', 'fomc',
  'euro', 'yen', 'pound', 'dollar', 'forex', 'commodity',
  // Crypto & DeFi
  'bitcoin', 'btc', 'ethereum', 'eth', 'solana', 'sol', 'xrp',
  'crypto', 'blockchain', 'defi', 'nft', 'altcoin', 'stablecoin',
  'binance', 'coinbase', 'ftx', 'sec', 'cftc', 'etf', 'halving',
  'doge', 'bnb', 'avax', 'matic', 'ada', 'dot', 'link', 'uni',
  'spot etf', 'crypto regulation', 'wallet', 'exchange', 'token',
];
...
const BOOST = [
  ...
  'bitcoin', 'btc', 'ethereum', 'eth', 'solana', 'crypto etf',
  'french open', 'roland garros', 'world series', 'stanley cup',
];
